						...
						<div id="paging">
							<ul class="pagination">
								...
								<c:if test="${pageMaker.prev}">
									<li>
										<a href='<c:url value="/herethere/local_fair4?page=${pageMaker.startPage-1}"/>'
											aria-label="Previous">
								...
								<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
									<li>
										<a href='<c:url value="/herethere/local_fair4?page=${pageNum}"/>'>${pageNum}
										</a>
									</li>
								</c:forEach>
								...
								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
									<li>
										<a href='<c:url value="/herethere/local_fair4?page=${pageMaker.endPage+1}"/>'
											aria-label="Next">
