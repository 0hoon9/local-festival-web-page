...
<body>
	<h1>비밀번호 수정</h1>
	<form role="form" action="/member/passwordModify" method="post">
		현재 비밀번호: <input type="text" id="user_pw"><br>
		새로운 비밀번호: <input type="text" id="new_pw"><br>
		비밀번호 확인: <input type="text" id="new_pw_check"><br>
		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
		<input type="hidden" id="user_id" name="user_id" value=<sec:authentication property="principal.member.user_id"/> />
