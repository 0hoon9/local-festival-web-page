							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										...
										<form id="register-form" action="/member/join_admin" method="post" role="form" style="display: block;">
											<div class="form-group">
											...
											<div class="form-group">
												<input type="password" name="user_pw" id="password" tabindex="2" class="form-control"
													placeholder="Password">
											</div>
											<div class="form-group">
