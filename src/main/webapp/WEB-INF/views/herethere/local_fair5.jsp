			...
			<body>
				<div id="root">
					...
					<section id="container">
						...
						<div id="board">
							<ul>
								...
								<c:forEach items="${list}" var="list">
									...
									<c:if test="${list.area eq '경기' or list.area eq '강원'}">
										<li>
										<div class="list">
											<div class="thumbImg">
						...
						<div>
							<div class="option">
							<form id="searchForm" action="/herethere/local_fair5" method="get">
						...
						<div id="paging">
							<ul class="pagination">
								...
								<c:if test="${pageMaker.prev}">
									<li>
										<a href='<c:url value="/herethere/local_fair5?page=${pageMaker.startPage-1}"/>'
											aria-label="Previous">
								...
								<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
									<li>
										<a href='<c:url value="/herethere/local_fair5?page=${pageNum}"/>'>${pageNum}
										</a>
									</li>
								</c:forEach>
								...
								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
									<li>
										<a href='<c:url value="/herethere/local_fair5?page=${pageMaker.endPage+1}"/>'
											aria-label="Next">
