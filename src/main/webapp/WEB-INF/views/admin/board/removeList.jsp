	...
	<section id="container">
		...
		<div id="container_box">
			<h3>삭제 게시글</h3>
				...
				<h6>게시글을 조회하려면 복원하세요</h6>
				<h6>여기서 게시글을 삭제하면 다시 조회할 수 없습니다</h6>
						...
						<tbody>
							<c:forEach items="${list}" var="board">
								<tr>
									...
									<td>
										<div>
											<button type="button" id="res_${board.bnum}_btn" data-bnum="${board.bnum}" class="btn btn-info btn-sm">복원</button>
									...
									<td>
										<div>
											<button type="button" id="del_${board.bnum}_btn" data-bnum="${board.bnum}" class="btn btn-danger btn-sm">삭제</button>
